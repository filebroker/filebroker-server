use crate::data::encode::{
    SUBMITTED_HLS_TRANSCODINGS, VIDEO_TRANSCODE_SEMAPHORE, media_has_audio, spawn_blocking,
};
use crate::error::{Error, TransactionRuntimeError};
use crate::model::{Broker, HlsStream, ObjectType, S3Object, User};
use crate::schema::{hls_stream, s3_object};
use crate::task::LockedObjectsTaskSentinel;
use crate::util::{format_duration, join_api_url};
use crate::{acquire_db_connection, run_retryable_transaction, run_serializable_transaction};
use chrono::Utc;
